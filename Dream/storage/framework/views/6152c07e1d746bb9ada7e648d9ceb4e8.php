...
<head>
    ...
    <title>Reproducir - <?php echo e($playlist->nombre); ?></title>
        ...
        <div class="player-container">
            ...
            <div class="playlist-header">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1><i class="fas fa-play-circle me-2"></i><?php echo e($playlist->nombre); ?></h1>
                        <?php if($playlist->descripcion): ?>
                            <p class="text-muted mb-0"><?php echo e($playlist->descripcion); ?></p>
                        <?php endif; ?>
                        <small class="text-muted"><?php echo e(count($sonidosActivos)); ?> sonidos activos</small>
                    </div>
                    <div class="col-md-4 text-end">
                        <a href="<?php echo e(route('playlists.show', $playlist)); ?>" class="btn btn-outline-light me-2">
                            <i class="fas fa-edit me-1"></i>Gestionar
                        </a>
                        <a href="<?php echo e(route('playlists.index')); ?>" class="btn btn-outline-light">
            ...
            <div class="current-track">
                ...
                <div class="current-track-info" id="currentTrackInfo">
                    Playlist: <?php echo e($playlist->nombre); ?>
            ...
            <div class="track-list">
                ...
                <?php if(count($sonidosActivos) > 0): ?>
                    <?php $__currentLoopData = $sonidosActivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sonido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="track-item" data-track-index="<?php echo e($index); ?>" data-src="<?php echo e($sonido['ruta']); ?>">
                            <div class="track-info">
                                <div class="d-flex align-items-center flex-grow-1">
                                    <div class="track-number"><?php echo e($index + 1); ?></div>
                                    <div class="flex-grow-1 ms-3">
                                        <div class="fw-bold"><?php echo e($sonido['nombre']); ?></div>
                                        <small class="text-muted">Volumen: <?php echo e($sonido['volumen']); ?>%</small>
                                    </div>
                                </div>
                                <div class="track-duration" id="duration-<?php echo e($index); ?>">--:--</div>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    <div class="alert alert-info text-center">
                        ...
                        <a href="<?php echo e(route('playlists.show', $playlist)); ?>" class="alert-link">Agrega algunos sonidos</a>.
                    </div>
                <?php endif; ?>
            </div>
    ...
    <script>
        class PlaylistPlayer {
            ...
            updateTrackDisplay() {
                ...
                this.currentTrackInfo.textContent = `Playlist: <?php echo e($playlist->nombre); ?> • Track ${this.currentTrackIndex + 1} de ${this.tracks.length}`;
            }
...
</html><?php /**PATH C:\laragon\www\Proyecto-carpeta_principal\Dream\Dream\resources\views/ventana playlista/reproducir.blade.php ENDPATH**/ ?>