...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-nav">
            <a class="nav-link" href="<?php echo e(route('mi-perfil')); ?>"><i class="fas fa-user me-1"></i>Perfil</a>
            <a class="nav-link" href="<?php echo e(route('configuracion-idioma')); ?>"><i class="fas fa-globe me-1"></i>Idioma</a>
    ...
    <div class="container">
        ...
        <div class="buttons-container">
            <a href="<?php echo e(route('inicio-sesion')); ?>" class="btn btn-login">
                <i class="fas fa-sign-in-alt btn-icon"></i>
                <span class="btn-text">Inicio de Sesión</span>
            </a>
            
            <a href="<?php echo e(route('asistente-sueno')); ?>" class="btn btn-assistant">
                <i class="fas fa-robot btn-icon"></i>
                <span class="btn-text">Asistente de Sueño</span>
            </a>
            
            <a href="<?php echo e(route('playlist-relajante')); ?>" class="btn btn-playlist">
                <i class="fas fa-music btn-icon"></i>
                <span class="btn-text">Playlist Relajante</span>
            </a>
            
            <a href="<?php echo e(route('notificaciones')); ?>" class="btn btn-notification">
...
<?php /**PATH C:\laragon\www\sueñito\Dream\resources\views/ventana principal/index.blade.php ENDPATH**/ ?>