...
<head>
    ...
    <title>Editar Playlist - <?php echo e($playlist->nombre); ?></title>
...
<body>
    <div class="container py-4">
        <div class="edit-container">
            ...
            <form action="<?php echo e(route('playlists.update', $playlist)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="nombre" 
                                   name="nombre" 
                                   value="<?php echo e(old('nombre', $playlist->nombre)); ?>" 
                                   required 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="descripcion" 
                                      rows="4" 
                                      placeholder="Describe tu playlist..."><?php echo e(old('descripcion', $playlist->descripcion)); ?></textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="info-card">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="fw-bold"><?php echo e($playlist->cantidad_sonidos); ?></div>
                            </div>
                            <div class="mb-2">
                                <small class="text-muted">Creada:</small>
                                <div class="fw-bold"><?php echo e($playlist->created_at->format('d/m/Y')); ?></div>
                            </div>
                            <div class="mb-2">
                                <small class="text-muted">Última modificación:</small>
                                <div class="fw-bold"><?php echo e($playlist->updated_at->format('d/m/Y H:i')); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="info-card mt-3">
                            ...
                            <div class="d-grid gap-2">
                                <a href="<?php echo e(route('playlists.show', $playlist)); ?>" class="btn btn-outline-info btn-sm">
                                    <i class="fas fa-music me-1"></i>Gestionar Sonidos
                                </a>
                                <a href="<?php echo e(route('playlists.reproducir', $playlist)); ?>" class="btn btn-outline-success btn-sm">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo e(route('playlists.index')); ?>" class="btn btn-outline-light w-100">
            ...
            <div class="mt-5 pt-4 border-top border-secondary">
                ...
                <form action="<?php echo e(route('playlists.destroy', $playlist)); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\Proyecto-carpeta_principal\Dream\Dream\resources\views/ventana playlista/edit.blade.php ENDPATH**/ ?>