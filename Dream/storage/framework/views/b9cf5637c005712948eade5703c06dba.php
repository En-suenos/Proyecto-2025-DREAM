...
<head>
    ...
    <title>Gestionar Playlist - <?php echo e($playlist->nombre); ?></title>
...
<body>
    <div class="container py-4">
        <div class="playlist-container">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <h1><i class="fas fa-music me-2"></i><?php echo e($playlist->nombre); ?></h1>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input toggle-sonido" 
                                               type="checkbox" 
                                               <?php echo e($sonido['activo'] ?? true ? 'checked' : ''); ?>

                                               data-playlist-id="<?php echo e($playlist->id); ?>"
                                               data-sonido-id="<?php echo e($sonido['id']); ?>">
                                    </div>
                                    <div>
                                        <h6 class="mb-1"><?php echo e($sonido['nombre']); ?></h6>
                                        <small class="text-muted"><?php echo e($sonido['archivo']); ?></small>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="volume-control me-3">
                                        ...
                                        <input type="range" class="form-range volume-slider" 
                                               min="0" max="100" value="<?php echo e($sonido['volumen'] ?? 80); ?>"
                                               data-playlist-id="<?php echo e($playlist->id); ?>"
                                               data-sonido-id="<?php echo e($sonido['id']); ?>">
                                    </div>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="d-flex justify-content-between align-items-center p-3 bg-dark bg-opacity-25 rounded">
                                <div>
                                    ...
                                    <span><?php echo e($sonido['nombre']); ?></span>
                                </div>
...
</html><?php /**PATH C:\laragon\www\Proyecto-carpeta_principal\Dream\Dream\resources\views/ventana playlista/show.blade.php ENDPATH**/ ?>