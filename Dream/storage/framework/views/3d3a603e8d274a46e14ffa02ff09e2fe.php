...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('perfil.index')); ?>">Mi perfil</a></li> <!-- Enlace a la vista de perfil, se conecta con rutas -->
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('playlists.index')); ?>">PlayLists</a></li> <!-- Enlace a la vista de PlayLists, se conecta con rutas -->
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('asistente ia.index')); ?>">Asistente</a></li> <!-- Enlace a la vista de Asistente IA, se conecta con routas-->
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('inicio_sesion.index')); ?>">Iniciar sesión</a></li> <!-- Enlace a la vista de inicio de sesión, se conecta con rutas -->
    ...
    <main class="container main-content">
        ...
        <div id="perfil" class="hidden">
            ...
            <a href="<?php echo e(route('ventana principal.index')); ?>" class="btn btn-secondary mt-3">
...
<?php /**PATH C:\laragon\www\Proyecto-carpeta_principal\Dream\resources\views/usuarios con cuenta/index.blade.php ENDPATH**/ ?>