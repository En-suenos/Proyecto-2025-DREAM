...
<body>
    <div class="report-container">
        ...
        <div class="report-meta">
            ...
            <div class="report-id">ID Reporte: USR-{{ date('Ymd-His') }}</div>
        </div>
        
        <!-- Resumen del reporte -->
        <!-- <div class="report-summary">
            <div class="summary-item">
                <div class="summary-value">{{ count($usuarios) }}</div>
                <div class="summary-label">Total de Usuarios</div>
            </div>
            <div class="summary-item">
                <div class="summary-value">{{ $usuariosActivos ?? count($usuarios) }}</div>
                <div class="summary-label">Usuarios Activos</div>
            </div>
            <div class="summary-item">
                <div class="summary-value">{{ $usuariosRecientes ?? 0 }}</div>
